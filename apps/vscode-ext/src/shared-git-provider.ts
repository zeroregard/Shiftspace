...
export class SharedGitProvider implements vscode.Disposable {
  ...
  private async doInitialize(): Promise<void> {
    ...
    this._repoTracker.startWatching(handleRepoSwitch);

    // React to repoDiscovery setting changes
    this._settingsDisposable = this._repoTracker.watchSettings(handleRepoSwitch);
  ...
  dispose(): void {
    ...
    this._settingsDisposable = undefined;
