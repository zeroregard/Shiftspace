...
const FileIconSvg: React.FC<FileShapeProps> = ({ color, abbrev, size }) => (
  ...
  >
    {/* Document body */}
    <path d="M2 1.5H8L12 5.5V12.5C12 12.8 11.8 13 11.5 13H2.5C2.2 13 2 12.8 2 12.5V1.5Z" fill={color} />
    {/* Fold crease */}
...
const FolderIconSvg: React.FC<FolderShapeProps> = ({ color, size }) => (
  ...
  >
    {/* Folder tab */}
    <path d="M1 6V4.5C1 4.2 1.2 4 1.5 4H5.5L7 2.5H12.5C12.8 2.5 13 2.7 13 3V6" fill={color} fillOpacity="0.75" />
    {/* Folder body */}
