...
const VARIANT_CLASSES: Record<BadgeVariant, string> = {
  error:
    'text-status-deleted border-status-deleted/30 bg-status-deleted/10',
  warning:
    'text-status-modified border-status-modified/30 bg-status-modified/10',
  finding: 'text-text-muted border-text-muted/20 bg-text-muted/5',
  info: 'text-teal border-teal/30 bg-teal/10',
  success:
    'text-status-added border-status-added/30 bg-status-added/10',
};
